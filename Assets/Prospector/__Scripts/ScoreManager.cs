...
public class ScoreManager : MonoBehaviour
{
     ...
     void Awake()
    {
        ...
        // check if a highscore in playerprefs
     ...
     void Event(eScoreEvent evt)
    {
        switch (evt)
        {
            //same needs to happen for all events 
            case eScoreEvent.draw: //draw card
            case eScoreEvent.gameWin: // win round 
            case eScoreEvent.gameLoss: // lose round
                chain = 0;
                score += scoreRun;
                scoreRun = 0;
                break;
